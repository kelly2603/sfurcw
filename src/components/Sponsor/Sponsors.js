...
import Img1 from "./sponsor_images/sqare himr_logo-2024_main_high_quality.png"
import Img2 from "./sponsor_images/SolidWorks-Logo.png"
import Img3 from "./sponsor_images/Altium___Black_Logo.jpg"
...
const Sponsors = () => {
    ...
    return (
        <div className='section-container center'>
            <h4>Sponsors</h4>
            <p className='subtitle'>Thank you to our sponsors!</p>
