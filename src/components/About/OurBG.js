        ...
        <div className='OBG-container section-container'>
            <div className='desc-container'>
                ...
                <div className='MS-container'>
                   <h4>Our Mission</h4>
                    <p>
                        At Ascension Robotics, our mission is to empower students of all backgrounds and skill levels to explore robotics through collaboration, mentorship, and real-world challenges. We strive to foster a supportive environment where members can gain hands-on experience, tackle ambitious projects, and represent SFU on global stages such as the RoboMaster competition. By combining technical excellence with teamwork and creativity, we aim to develop the next generation of innovators, leaders, and problem solvers. Our current goals include improving our current three robots (Infantry, Hero, and Sentry) for the next RMNA competition as well as building an Engineer robot and a Dart system, putting us one step closer to competing in the 7v7 gamemode. In 2027, with an even larger and more experienced team, as well as funding and support from sponsors, we hope to compete in the RoboMaster University Championship in the 7v7 against the best teams in China and across the world, and marking our legacy as one of the best teams in North America.
                    </p> 
                </div>
            </div>
